...
abstract class TweetSet {
  ...
  /**
   * Helper method for mostRetweeted that propagates the accumulated tweets
   */
...
class Empty extends TweetSet {
  ...
  /**
   * Definition from abstract.  Defined in subclass.  
   */
  def mostRetweeted: Tweet = throw new NoSuchElementException("most retweeted is empty")
